...
namespace IQToolkit
{
   ...
   public class ExpressionComparer
   {
      ...
      public static bool AreEqual(ScopedDictionary<ParameterExpression, ParameterExpression> parameterScope, Expression a, Expression b,
                                  Func<object, object, bool> fnCompare) => new ExpressionComparer(parameterScope, fnCompare).Compare(a, b);
      ...
      protected virtual bool CompareUnary(UnaryExpression a, UnaryExpression b) =>
         a.NodeType == b.NodeType && a.Method == b.Method && a.IsLifted == b.IsLifted && a.IsLiftedToNull == b.IsLiftedToNull && Compare(a.Operand, b.Operand);
      ...
      protected virtual bool CompareMemberAccess(MemberExpression a, MemberExpression b) => a.Member == b.Member && Compare(a.Expression, b.Expression);
      ...
      protected virtual bool CompareLambda(LambdaExpression a, LambdaExpression b)
      {
         ...
         try
         {
            for (int i = 0; i < n; i++) parameterScope.Add(a.Parameters[i], b.Parameters[i]);
      ...
      protected virtual bool CompareMemberAssignment(MemberAssignment a, MemberAssignment b) => a.Member == b.Member && Compare(a.Expression, b.Expression);
      ...
      protected virtual bool CompareElementInit(ElementInit a, ElementInit b) => a.AddMethod == b.AddMethod && CompareExpressionList(a.Arguments, b.Arguments);
   }
}
