...
namespace EFC
{
   ...
   {
      public static EntityTypeBuilder<TEnumeration> EntityEnumeration<TEnumeration>(this ModelBuilder modelBuilder)
      ...
      public static EntityTypeBuilder<TEnumeration> EntityEnumeration<TEnumeration, TBaseEnumeration>(this ModelBuilder modelBuilder)
         where TEnumeration : Enumeration<TBaseEnumeration> where TBaseEnumeration : Enumeration<TBaseEnumeration>
      {
         EntityTypeBuilder<TEnumeration> entityTypeBuilder = modelBuilder.Entity<TEnumeration>();
